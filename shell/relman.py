...
# Dry-run для создания MR (без фактического создания MR):
    ./relman.py create mr https://gitlab.platform.corp/magnitonline/mm/backend/api-graphql --from "development" --to "stage" --dry-run
    ./relman.py create mr --batch --target "prod" --dry-run
