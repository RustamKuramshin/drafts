# В  этом разделе рекомендации только для `shell/relman.py`

Этот раздел фиксирует проектные договорённости и практические инструкции для дальнейшей разработки `shell/relman.py`.
